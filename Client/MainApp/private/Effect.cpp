...
HRESULT CEffect::Initialize(void* pArg)
{
    ...
    MD.DiffuseMapIndex = m_GameInstance->Add_Texture("Effect_D", CTexture::Create(L"../bin/Models/Effect/Explode_8x8.dds"));
    MD.NormalMapIndex = m_GameInstance->Add_Texture("Effect_N", CTexture::Create(L"../bin/Models/Effect/Explode_8x8.dds"));
