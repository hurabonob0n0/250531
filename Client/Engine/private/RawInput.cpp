...
IMPLEMENT_SINGLETON(CRawInput)

inline CRawInput::CRawInput() {}

HRESULT CRawInput::Initialize(HWND hWnd)
{
...
void CRawInput::Update_InputDev(LPARAM lParam)
{
	UINT dwSize = 0;
